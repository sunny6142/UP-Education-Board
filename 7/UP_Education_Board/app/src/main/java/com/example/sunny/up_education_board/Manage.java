...
public class Manage extends AppCompatActivity implements
        NavigationView.OnNavigationItemSelectedListener , OnPictureCapturedListener, ActivityCompat.OnRequestPermissionsResultCallback, OngetLocation ,
    ...
    String locationmodule = "LocationManager.NETWORK_PROVIDER";
    //End Navi
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startbut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(Manage.this , "Not Accessible" , Toast.LENGTH_LONG).show();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_attendence) {
            ...
            FragmentManager fragmentManager = getFragmentManager();
            fragmentManager.beginTransaction()
                    .replace(R.id.content_manage_frame,new studentleave()).commit();
        }
    ...
    public void GetValue() //tarea , tlat , tlong , tname,timein , timeout , locationname;
    {
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(pstart == 0) {
                    Map<String, String> key = (Map<String, String>) dataSnapshot.child("location").getValue();
                    //      tarea , tlat , tlong , tname,timein , timeout , locationname;
                    tarea = (String) key.get("area");
                    tlat = (String) key.get("lat");
                    tlong = (String) key.get("long");
                    Map<String, String> key1 = (Map<String, String>) dataSnapshot.child("time").getValue();
    ...
    public void GDATE() {
        ...
        timeRef = Database.getReference("timetest").child("ABCDF").child(key).child("time");
    ...
    public void onPostExecute() {
        ...
        if(!statusOfGPS)
        {
            displayPromptForEnablingGPS(Manage.this);
        }
...
//////////////////////////////////////////////////////////////////////////////////////////////350000
                                    ...
                                    if(pass == true) {
                                        ...
                                        if (timein != null) {
                                            if(time != 0){
                                                ...
                                                time = Integer.parseInt(settime) + 1;
                                            }
                                            int a = time ;//Integer.parseInt(settime) + 1;
    ...
    private void CheckTimeisinbetween() {
        ...
        statusOfGPS = manager.isProviderEnabled(LocationManager.GPS_PROVIDER);
        Log.e("PPPP", String.valueOf(statusOfGPS));
        if(!statusOfGPS){
            pd.dismiss();
            settoday.setText("GPS connection not Lost !");
            yourouttime.setText("unknown");
            t.interrupted();
            pass = false;
            return;
        }
     ...
     //   timeRef.setValue(ServerValue.TIMESTAMP);
        ...
        else if(tm1.clock.equals("AM") && tm2.clock.equals("PM"))
        {
            if(tm1.clock.equals("AM") && tm3.clock.equals("AM") && tm1.hr < tm3.hr) {
                pass = true;
            }
            else if(tm1.clock.equals("AM") && tm3.clock.equals("AM") && tm1.hr == tm3.hr && tm1.min <= tm3.min) {
                pass = true;
            }
            if(tm2.clock.equals("PM") && tm3.clock.equals("PM") && tm2.hr > tm3.hr) {
                pass = true;
            }
            else if(tm2.clock.equals("PM") && tm3.clock.equals("PM") && tm2.hr == tm3.hr && tm2.min >= tm3.min) {
                pass = true;
            }
        }
    }
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        mLocationRequest.setInterval(600000); // Update location every second
        ...
        if (mLastLocation != null) {
         ...
         //       txt_lng.setText("Current Longitude is" + c_lon);
                Log.e("Lat and Lng", String.valueOf(storelat)+storelong);
            }
        }
    }
    synchronized void buildGoogleApiClient() {
        mGoogleApiClient = new GoogleApiClient.Builder(Manage.this)
...
/////////////////////////////////////////////////////////////////////////////////////////
                ...
                if (results < Double.parseDouble(tarea) && pass == true && statusOfGPS) {
                    if (!t.isAlive()) {
                        t.start();
                    }
                } else {
                    ...
                    ref = Database.getReference().child(LoginActivity.schoolcode);

                    Log.e("MMM",LoginActivity.schoolcode);
                    ref.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if (dataSnapshot.child(parts[0] + " " + parts[1] + " " + parts[2]).hasChild(tname)) {
                                Log.e("MMM4", String.valueOf(pass));
                                ...
                                Log.e("MMM5", String.valueOf(timein));

                                Log.e("MMM6", String.valueOf(tout));
